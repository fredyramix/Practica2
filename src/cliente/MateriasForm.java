 ...
 * @author freddy
 */
public class MateriasForm extends javax.swing.JInternalFrame {
cliente clie;
...
Materia mat = new Materia();
    public MateriasForm() 
    {
        ...
        try {
            ...
            lista_escuelas_combo = op.listaMaterias();
            for(int i=0;i<lista_escuelas_combo.size();i++)
            {
                mat=(Materia)lista_escuelas_combo.get(i);
                CarreraDAO cdao = new CarreraDAO();
                Carrera c ;
                c=cdao.buscar(mat.getCarrera().getIdcarrera()); 
                jComboBox1.addItem(mat.getCarrera().getIdcarrera()+"-"+c.getNombre());
            ...
            Logger.getLogger(MateriasForm.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            mat.setNombre(jTextField2.getText());
            ...
            car.setIdcarrera(Integer.parseInt(part));
            mat.setCarrera(car);
            try {
                interfaces op;
                op = (interfaces) Naming.lookup("rmi://localhost/persistencia");
                if (op.insertarMateria(mat)) 
                {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            {
            mat.setNombre(jTextField2.getText());
             mat.setIdmateria(Integer.parseInt(jLabel5.getText()));
            String texto =(String) jComboBox1.getSelectedItem();
            System.out.println(texto);
            String[] parts = texto.split("-");
            String part =parts[0];
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            if (this.jTextField2.getText().length()>0)
            {
                interfaces op;
                op = (interfaces) Naming.lookup("rmi://localhost/persistencia");
                mat.setNombre(this.jTextField2.getText());
                mat.setIdmateria(Integer.parseInt(jLabel5.getText()));
                if (op.eliminarMateria(mat)) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            mat=op.buscaMateria(Integer.parseInt(jTextField1.getText()));
            if (mat != null)
            {
                this.jLabel5.setText(Integer.toString(mat.getIdmateria()));
                this.jTextField2.setText(mat.getNombre());
                this.jTextField3.setText(mat.getCredito());
                this.jTextField1.setText("");
                CarreraDAO edao = new CarreraDAO();
                Carrera c ;
                c=edao.buscar(mat.getCarrera().getIdcarrera()); 
                this.jComboBox1.setSelectedItem(mat.getCarrera().getIdcarrera()+"-"+c.getNombre());
                this.jTextField1.setText("");
